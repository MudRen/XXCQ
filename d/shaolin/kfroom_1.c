...
void create()
{
	set("short", "始武房");
	set("long", @LONG
始武房是少林功夫房之一，内有精妙机关，置身其内可以很快的提升
...
void init()
{
	...
	if (userp(me) && me->query_temp("kfroom_1"))
...
{
	if( me->query_temp("kfroom_1") && dir == "east")
	{
		me->apply_condition("kf_job",10);
	}
