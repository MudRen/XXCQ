...
mapping *action = ({
([      "action" : "$N对着$n大喝一声「看招」，左手执刃，一招「劈天盖地满壮志」，刀锋自上而下向$n的$l挥去",
        "force" : 160,
        "dodge" : 10,
        "damage": 25,
        "lvl" : 0,
...
([      "action" : "$N一招「弯刀逆转倒乾坤」，手中$w在空中急速转动数圈，直绕得$n头昏眼花，快速划向$n的$l",
        "force" : 200,
        "dodge" : 10,
        "damage": 45,
        "lvl" : 40,
...
([      "action" : "$N猛一挫身，一招「遥看万疆千里雪」，手中$w快刀斩乱麻，直接奔向$n的$l斩去",
        "force" : 260,
        "dodge" : 5,
        "damage": 65,
        "lvl" : 60,
...
([      "action" : "$N一招「壮志豪气满江湖」，无数刀尖化作点点繁星，向$n的$l挑去，让$n简直无法招架",
        "force" : 300,
        "dodge" : 5,
        "damage": 90,
        "lvl" : 80,
