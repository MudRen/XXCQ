...
void create()
{
    set("short", "黄河东岸");
    set("long", @LONG
面前是波涛翻滚的黄河(river)。浊流滚滚，万舟竞发。龙门
瀑布,就在不远的地方,你可以看见血河派了。
LONG );
    set("exits", ([
        "south" : "/d/longmen/sroad3",
    ]));
    set("item_desc", ([
...
void arrive()
{
    ...
    if( room = find_object(__DIR__"duchuan") )
    {
        room->set("exits/out", __DIR__"yellw");
