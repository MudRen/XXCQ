...
void create()
{
        set_name("叶楚甚", ({ "ye chushen","ye"}) );
        set("gender", "男性" );
        set("age", 24);
        set("per", 20);
        set("long",
                "叶梦甚是“飞鱼塘”飞鱼山庄庄中最重要的“老秀”之一，他精通飞鱼剑法。\n他看上去大约二十多岁，虎背熊腰，五官轮廓隐似一座石雕像。\n");
...
void attempt_apprentice(object me)
{
        ...
        command("say 飞鱼塘的剑法博大精深，你要好好的学呀!");
