...
void check(object me)
{
	...
	if ( my_fam["master_id"] == ob->query("id")
		...
		&& (me->query_skill("cibei-dao",1) > 60 || me->query_skill("shaolin-quan",1)>60)
		&& !me->query("bai_tian")
		&& environment(me)==environment(ob))
	{
		...
		command("say 以后不要忘了为师的教诲：神奇卓异非至人，至人只是常。去吧。");
		me->set("bai_tian", 1);
	}
}
