...
void check(object me)
{
	...
	if ( my_fam["master_id"] == ob->query("id")
		...
		&& (me->query_skill("damo-jian",1) > 60 || me->query_skill("fozhao-gong",1)>60)
		&& !me->query("bai_tian")
		&& environment(me)==environment(ob))
	{
		...
		command("say 以后不要忘了为师的教诲：栖恬守逸之味，最淡亦最长。去吧。");
		me->set("bai_tian", 1);
	}
}
